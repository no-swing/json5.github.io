...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _init: function (options, refreshMode) {
            ...
            self.uploadFileAttr = !$h.isEmpty($el.attr('data-name')) ? $el.attr('data-name') : 'file_data';
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeClass: 'btn btn-sm btn-kv btn-light ',
                    removeErrorClass: 'btn btn-sm btn-kv btn-danger',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="iconfont">&#xe616;</i>',
                    uploadClass: 'btn btn-sm btn-kv btn-light ',
                    uploadTitle: 'Upload file',
                    uploadRetryIcon: '<i class="glyphicon glyphicon-repeat"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="glyphicon glyphicon-download"></i>',
                    downloadClass: 'btn btn-sm btn-kv btn-light ',
                    downloadTitle: 'Download file',
                    zoomIcon: '<i class="iconfont">&#xe672;</i>',
                    zoomClass: 'btn btn-sm btn-kv btn-light ',
                    zoomTitle: 'View Details',
                    dragIcon: '<i class="glyphicon glyphicon-move"></i>',
                    dragClass: 'text-info',
                    dragTitle: 'Move / Rearrange',
                    dragSettings: {},
                    indicatorNew: '<i class="iconfont text-warning"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            toggleheader: '<i class="iconfont">&#xe84e;</i>',
            fullscreen: '<i class="iconfont">&#xe884;</i>',
            borderless: '<i class="iconfont">&#xe602;</i>',
            close: '<i class="iconfont">&#xe68b;</i>'
        },
        ...
        pauseClass: 'btn btn-light btn-secondary',
        uploadIcon: '<i class="iconfont">&#xe616;</i>',
